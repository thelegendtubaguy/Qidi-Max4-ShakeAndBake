# external-belt-analysis Specification

## Purpose
External belt analysis reads Shake&Bake CoreXY A/B belt capture artifacts outside Klipper and writes comparison metrics, diagnostics, summaries, and graphs without contacting the printer or editing configuration.
